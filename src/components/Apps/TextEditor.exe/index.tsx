			...
			contextMenus={
				<>
					<ContextualBar.Menu name="Fichier">
						<ContextualBar.Item
							onClick={() => {
								beacon("triggerStep", { value: "saveFile" });
		...
		>
			<EditorProvider>
				<section className="relative flex flex-row flex-wrap flex-1 w-full overflow-auto text-black bg-[#F5F5F5] backdrop-blur dark:bg-black/70">
					<Toolbar>
						<button onClick={() => handleFormat("bold")} className="flex items-center justify-center p-1 font-bold transition rounded-sm hover:bg-gray-50 hover:bg-opacity-40">B</button>
						<button onClick={() => handleFormat("italic")} className="flex items-center justify-center p-1 italic transition rounded-sm hover:bg-gray-50 hover:bg-opacity-40">I</button>
						<button onClick={() => handleFormat("underline")} className="flex items-center justify-center p-1 underline transition rounded-sm hover:bg-gray-50 hover:bg-opacity-40">U</button>
						<button
