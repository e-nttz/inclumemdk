	...
	return (
		<body className="bg-gray-50">
			...
			<section className="py-16 text-center bg-white">
				...
				<p className="mt-2 text-gray-700">
					Email : <button className="text-orange-600 underline">Bng@outmail.com</button>
				</p>
				<p className="mt-2 text-gray-700">
...
Bng.componentName = "Bng";
// used in tab as site title
Bng.title = "Bng - La banque proche de vous";
// used in searchEngine
Bng.excerpt = "Découvrez la banque préférée de Wap-e.";
...
// Site favicon icon
Bng.favicon = <IconSearchEngine />;

Bng.pages = [
	{
		title: "Bng - Banking",
		url: "https://www.bng-banque.be",
	},
];
