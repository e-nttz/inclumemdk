...
export const OS = () => {
	...
	return (
		<div
			data-theme={theme}
			className="relative min-h-screen bg-white bg-[url('/images/wallpaper.jpg')] bg-cover bg-center transition-all flex flex-col overflow-hidden text-gray dark:text-white dark:[color-scheme:dark]"
			id="inclume-os"
		>
			{!isAuth && (
