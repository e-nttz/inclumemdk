...
export const getMailsFromLocalStorage = (userEmail: string) => {
    const localStorageKey = `userMails_${userEmail}`;  // Utilisez un identifiant unique pour l'utilisateur
...
export const saveMailsToLocalStorage = (userEmail: string, mails: any[]) => {
    const localStorageKey = `userMails_${userEmail}`;  // Utilisez un identifiant unique pour l'utilisateur
...
export const resetLocalStorage = (userEmail: string) => {
